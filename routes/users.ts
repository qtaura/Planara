...
router.post(
  ...
  EmailVerificationController.sendCode
);
router.post(
  '/auth/verify-code',
  perEmailVerifyLimiter,
...
router.post(
  ...
  strictLimiter,
  adminOnly,
  EmailVerificationController.adminUnlock
);
router.get(
  '/auth/admin/lockout-state/:email',
  authenticate,
  adminOnly,
  EmailVerificationController.getLockoutState
);
router.get(
  '/auth/admin/events/:email',
  authenticate,
  adminOnly,
  EmailVerificationController.getSecurityEvents
);
router.get(
  '/auth/admin/rotations/:email',
  authenticate,
  adminOnly,
  EmailVerificationController.getRotationHistory
);
