...
export class AddPerformanceIndexes1703000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_user_verified_status" ON "user" ("isVerified")`
    );

    // Project-related indexes
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_project_owner_id" ON "project" ("ownerId")`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_project_favorite" ON "project" ("favorite")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_project_created_at" ON "project" ("createdAt")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_project_owner_archived" ON "project" ("ownerId", "archived")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_project_team_archived" ON "project" ("teamId", "archived")`
    );
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_task_milestone_id" ON "task" ("milestoneId")`
    );
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_task_project_assignee" ON "task" ("projectId", "assigneeId")`
    );

    // Comment-related indexes
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_comment_task_id" ON "comment" ("taskId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_comment_author_id" ON "comment" ("authorId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_comment_thread_id" ON "comment" ("threadId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_comment_parent_id" ON "comment" ("parentCommentId")`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_milestone_project_id" ON "milestone" ("projectId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_milestone_due_date" ON "milestone" ("dueDate")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_milestone_progress" ON "milestone" ("progressPercent")`
    );
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_notification_project_id" ON "notification" ("projectId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_notification_task_id" ON "notification" ("taskId")`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_organization_owner_id" ON "organization" ("ownerUserId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_organization_name_lower" ON "organization" ("nameLower")`
    );
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_team_org_id" ON "team" ("orgId")`);
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_team_name_lower" ON "team" ("nameLower")`
    );

    // Membership indexes
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_membership_user_id" ON "membership" ("userId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_membership_org_id" ON "membership" ("orgId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_membership_team_id" ON "membership" ("teamId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_membership_role" ON "membership" ("role")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_membership_user_org" ON "membership" ("userId", "orgId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_membership_user_team" ON "membership" ("userId", "teamId")`
    );

    // Attachment indexes
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_attachment_task_id" ON "attachment" ("taskId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_attachment_project_id" ON "attachment" ("projectId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_attachment_mime_type" ON "attachment" ("mimeType")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_attachment_created_at" ON "attachment" ("createdAt")`
    );

    // File version indexes
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_file_version_attachment_id" ON "file_version" ("attachmentId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_file_version_number" ON "file_version" ("versionNumber")`
    );

    // Thread indexes
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_thread_task_id" ON "thread" ("taskId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_thread_root_comment_id" ON "thread" ("rootCommentId")`
    );
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_refresh_token_revoked" ON "refresh_token" ("isRevoked")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_refresh_token_user_revoked" ON "refresh_token" ("userId", "isRevoked")`
    );

    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_email_verification_user_id" ON "email_verification_code" ("userId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_email_verification_expires_at" ON "email_verification_code" ("expiresAt")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_email_verification_used" ON "email_verification_code" ("isUsed")`
    );

    // Notification preference indexes
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_notification_preference_user_id" ON "notification_preference" ("userId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_notification_preference_type" ON "notification_preference" ("type")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_notification_preference_channel" ON "notification_preference" ("channel")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_notification_preference_enabled" ON "notification_preference" ("enabled")`
    );
  }
